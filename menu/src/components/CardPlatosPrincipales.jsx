  ...
  return (
    ...
    <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant="" src={bistec} alt="Papas Cerveceras" height="180" />
        <Card.Body>
        ...
        <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant="" src={sanguchevacio} alt="Papas Cerveceras" height="180" />
        <Card.Body>
        ...
        <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant="" src={humita} alt="Humita de Olla" height="180" />
        <Card.Body>
        ...
        <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant="" src={lasaña} alt="Lasaña" height="180" />
        <Card.Body>
        ...
        <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant=" " src={locro} alt="Lasaña" height="180" />
        <Card.Body>
        ...
        <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant="" src={sorrentinos} alt="Sorrentinos" height="180" />
        <Card.Body>
    ...
    <div className='m-2'>
      <Card style={{ width: '16rem' }} className='bg-dark'>
        <Card.Img variant="" src={Banner} alt="Papas Cerveceras" height="180" />
        <Card.Body>
      ...
      <div className='m-2'>
      <Card style={{ width: '16rem' }}  className='bg-dark'>
        <Card.Img variant="" src={Banner2} alt="Papas Cerveceras"height="180" />
        <Card.Body>
